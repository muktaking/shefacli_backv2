...
exports.UserExamCourseProfile = void 0;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => userExamProfile_entity_1.UserExamProfile, (userExamProfile) => userExamProfile.courses),
    __metadata("design:type", userExamProfile_entity_1.UserExamProfile)
], UserExamCourseProfile.prototype, "userExamProfile", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => userExamExamProfile_entity_1.UserExamExamProfile, (userExamExamProfile) => userExamExamProfile.course, { cascade: true, eager: true }),
